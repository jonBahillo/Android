   ...
   protected void onCreate(Bundle savedInstanceState) {
    ...
    private void cargarMapas() {
       ...
       /* CompassOverlay comOverlay = new CompassOverlay(this, new InternalCompassOrientationProvider(getApplicationContext()), myOpenMapView);
        ...
        for(int i = 0; i < posicion.size(); i++){
           ...
           if (posicion.get(i).getNombre().equals("HASIERA") || posicion.get(i).getNombre().equals("Amaiera") || posicion.get(i).getOrden().equals(Integer.toString(pasado))){
            ...
            Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString,
               ...
               // Log.d("mytag2", "nombre "+posicion.get(i).getPasado()+" "+posicion.get(i).getNombre() );
        ...
        ArrayList<Posiciones> posicionespasado =  MDB.recuperarposicionesuno(pasado+1);
        //&& !posicionespasado.get(0).getOrden().equals(posiciones.get(0).getOrden())
        ...
        for(int e = 0; e < rutas.size(); e++){
           ...
           // Log.d("mytag","aaa: "+posiciones.get(0).getOrden());
            ...
            if (pasado != 13){
                ...
                if(posiciones.get(0).getPasado() == 1 || posiciones.get(0).getOrden().equals(Integer.toString(pasadonumero))){
                   // Log.d("mytag","aaa: "+ posiciones.get(0).getOrden().equals(Integer.toString(pasado)));
      ...
      //  if (i != 0 && i == pasado){
        ...
        btnJugar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Log.d("mytag","posicio"+posicion.get(0).getJuegonombre());

                String activity = "com.example.ik_2dm3.maps2."+posicion.get(0).getJuegonombre();
                //String activity = "com.example.ik_2dm3.maps2.MainActivity_juegoimagenesdiferentes";
...
/*
        ...
        for(int e = 0; e < rutas.size(); e++){
            ...
            if (posiciones.get(0).getPasado() == 0){
                ptspasado.add(new GeoPoint(Latitud, Longitud));
                linepasado.setColor(Color.RED);
                linepasado.setTitle("Bigarren gunea");
                linepasado.setWidth(17f);
            ...
            }else if(posiciones.get(0).getPasado() == 1){
                pts.add(new GeoPoint(Latitud, Longitud));
                line.setColor(Color.GREEN);
                line.setTitle("Lehen gunea");
                line.setWidth(17f);
