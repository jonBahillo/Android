...
public class MainActivity_juegoMemoria extends AppCompatActivity {
    ...
    public void popup (View v){
        ...
        Aurrera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle extras = getIntent().getExtras();
                Integer index = extras.getInt("index");
                Intent salir = new Intent(MainActivity_juegoMemoria.this, TextoAudio.class);
                salir.putExtra("index", index.toString());
                setResult(RESULT_OK, salir);
                dialogo.dismiss();
                finish();
    ...
    public void iniciar(){
        /*int inicio=0;
        final Intent cargaI = new Intent(MainActivity_juegoMemoria.this, pantallacarga.class);
        if (inicio==0) {
